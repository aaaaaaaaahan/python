ERROR: duckdb.duckdb.ConversionException: Conversion Error: Could not convert string '\0' to INT32 when casting from source column C_IBS_E1_TO_E2

LINE 11:       AND RLENCODE IN (3,11,12,13,14,16,17,18,19,21,22,23,27,28)
...
con.execute(f"""
    ...
    SELECT 
        ...
        C_IBS_E1_TO_E2  AS RLENCODE,
        C_IBS_E2_TO_E1  AS PRISEC
    FROM rlen_files
    WHERE PRISEC = 901
