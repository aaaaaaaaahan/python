...
#---------------------------------------------------------------------#
# Original Program: CIHRCDR1                                          #
#---------------------------------------------------------------------#
# ESMR 2014-2296                                                      #
# -GENERATE DAILY HRC SUMMARY REPORT BY STATUS                        #
# ESMR 2016-197: ADD NEW STATUS '11' TO CALCULATE IN HRC REPORT       #
...
csv_path = csv_output_path(f"CISHRC_STATUS_DAILY_{report_date}")
txt_path = csv_path
