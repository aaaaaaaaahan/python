...
//*--------------------------------------------------------------------
//*--- ESMR 2012-0960 ENHANCE ALERT REPORT TO EXCLUDE IF:
//*    REVIEWED EARLIER = NO,  VIEW BY BRANCH APPROVER = YES
//*    REVIEWED EARLIER = YES, VIEW BY BRANCH APPROVER = NO
//*    REVIEWED EARLIER = YES, VIEW BY BRANCH APPROVER = YES
//*--------------------------------------------------------------------
//*--- ESMR 2012-0909 ENHANCE ALERT REPORT TO EXCLUDE COUNT IF
//*    FOUND THE FOLLOWING PRODUCT CODE IN DEPOSIT REPORTS : -
//*    (126, 127, 128, 129, 140, 141, 142, 143, 144, 145, 146,
//*    147,148,149, 171, 172 & 173)
//*--------------------------------------------------------------------
//*--- ESMR 2011-3002 (OUTPUT FILE FTP TO BDS DAILY)
//**EXTRACT SUMMARY WITH THE FOLLOWING CRITERIAS:
//*    1 - HRC ACCOUNTS/CUSTOMERS RECORDS WITH VIEWED RECORDS < 100%
//*    2 - NON-HRC CUSTOMERS RECORDS WITH VIEWED RECORDS < 10%
//*--------------------------------------------------------------------
//INITDS   EXEC PGM=IEFBR14
//DEL1     DD DSN=RBP2.B033.CIS.CIREPTTT.SUMMARY,
...
//REPTFILE DD DISP=SHR,DSN=RBP2.B033.UNLOAD.CIREPTTT.FB
//*CTRLDATE DD DISP=SHR,DSN=RBP2.B033.SRSCTRL1(0)
//OUTFILE  DD DSN=RBP2.B033.CIS.CIREPTTT.SUMMARY,
