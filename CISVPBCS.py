...
//* ESMR 2011-428  IMIS - UNICARD MERCHANT CARD
//* ESMR 2011-428  IMIS - UNICARD DEBIT/CREDIT CARD
//* ESMR 2011-428  IMIS - PBCSS   PRIME
//* ESMR 2014-2571  LAM YEONG KANG
//* ADDITIONAL MATCHING CRITERIA - NAME AND DOB MATCHING(ADD DOB FIELD)
//*---------------------------------------------------------------------
//DELETE   EXEC PGM=IEFBR14
//DLT1     DD DSN=RBP2.B033.SNGLVIEW.PBCS,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT2     DD DSN=RBP2.B033.SNGLVIEW.PBCS01,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT3     DD DSN=RBP2.B033.SNGLVIEW.PBCS02,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT4     DD DSN=RBP2.B033.SNGLVIEW.PBCS03,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT5     DD DSN=RBP2.B033.SNGLVIEW.PBCS04,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT6     DD DSN=RBP2.B033.SNGLVIEW.PBCS05,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT7     DD DSN=RBP2.B033.SNGLVIEW.PBCS06,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT8     DD DSN=RBP2.B033.SNGLVIEW.PBCS07,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT9     DD DSN=RBP2.B033.SNGLVIEW.PBCS08,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT10    DD DSN=RBP2.B033.SNGLVIEW.PBCS09,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT11    DD DSN=RBP2.B033.SNGLVIEW.PBCS10,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//*---------------------------------------------------------------------
...
//MERCHANT  DD DISP=SHR,DSN=RBP2.B033.UNICARD.MERCHANT
//VISAFILE  DD DISP=SHR,DSN=RBP2.B033.UNICARD.VISA
//OUTFILE   DD DSN=RBP2.B033.SNGLVIEW.PBCS,
...
//SORTIN   DD DISP=SHR,DSN=RBP2.B033.SNGLVIEW.PBCS
//OUT01    DD DSN=RBP2.B033.SNGLVIEW.PBCS01,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT02    DD DSN=RBP2.B033.SNGLVIEW.PBCS02,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT03    DD DSN=RBP2.B033.SNGLVIEW.PBCS03,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT04    DD DSN=RBP2.B033.SNGLVIEW.PBCS04,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT05    DD DSN=RBP2.B033.SNGLVIEW.PBCS05,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT06    DD DSN=RBP2.B033.SNGLVIEW.PBCS06,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT07    DD DSN=RBP2.B033.SNGLVIEW.PBCS07,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT08    DD DSN=RBP2.B033.SNGLVIEW.PBCS08,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT09    DD DSN=RBP2.B033.SNGLVIEW.PBCS09,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//OUT10    DD DSN=RBP2.B033.SNGLVIEW.PBCS10,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(500,200),RLSE),
//            DCB=(LRECL=1000,BLKSIZE=0,RECFM=FB)
//SYSOUT   DD SYSOUT=*
