...
//DELE1    DD DSN=CIS.HRCCUST.OTACCTS.GOOD,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DELE2    DD DSN=CIS.HRCCUST.OTACCTS.CLOSED,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DELE3    DD DSN=CIS.HRCCUST.OTACCTS.GOOD.PBB,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DELE4    DD DSN=CIS.HRCCUST.OTACCTS.GOOD.PIBB,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//*---------------------------------------------------------------------
...
//HRCSTOT   DD DISP=SHR,DSN=CIS.HRCCUST.OTACCTS
//*OUTPUT FROM UNLOAD JOB CIUACCTB
//OTFILE    DD DISP=SHR,DSN=UNLOAD.CIACCTT.FB
//OUTOTGOD  DD DSN=CIS.HRCCUST.OTACCTS.GOOD,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE),
//             DCB=(LRECL=250,BLKSIZE=0,RECFM=FB)
//OUTOTBAD  DD DSN=CIS.HRCCUST.OTACCTS.CLOSED,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE),
//             DCB=(LRECL=250,BLKSIZE=0,RECFM=FB)
//SASLIST   DD SYSOUT=X
...
//SORTIN   DD DISP=SHR,DSN=CIS.HRCCUST.OTACCTS.GOOD
//OTCONV   DD DSN=CIS.HRCCUST.OTACCTS.GOOD.PBB,               00170000
//            DISP=(NEW,CATLG,DELETE),UNIT=SYSDA,
//            DCB=(LRECL=250,BLKSIZE=0,RECFM=FB),
//            SPACE=(CYL,(5,10),RLSE)
//OTPIBB   DD DSN=CIS.HRCCUST.OTACCTS.GOOD.PIBB,              00170000
//            DISP=(NEW,CATLG,DELETE),UNIT=SYSDA,
//            DCB=(LRECL=250,BLKSIZE=0,RECFM=FB),
//            SPACE=(CYL,(5,10),RLSE)
//SYSIN  DD *
