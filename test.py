...
CUSTMNTDATE use import datetime

//CIAMLHRC JOB MSGCLASS=X,MSGLEVEL=(1,1),REGION=128M,NOTIFY=&SYSUID
//*--------------------------------------------------------------------
//DELETE   EXEC PGM=IEFBR14
//DEL1     DD DSN=AMLHRC.EXTRACT.MASSCLS,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DEL2     DD DSN=AMLHRC.EXTRACT.VERIFY,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DEL3     DD DSN=AMLHRC.EXTRACT.MASSCLS.BNKSTFF,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//*
//GETCHG   EXEC SAS609
...
//CUSTCLS  DD DSN=AMLHRC.EXTRACT.MASSCLS,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(30,30),RLSE),
//            DCB=(LRECL=100,BLKSIZE=0,RECFM=FB)
//CUSTVRY  DD DSN=AMLHRC.EXTRACT.VERIFY,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(30,30),RLSE),UNIT=SYSDA,
//            DCB=(LRECL=100,BLKSIZE=0,RECFM=FB)
//CUSTBNK  DD DSN=AMLHRC.EXTRACT.MASSCLS.BNKSTFF,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(CYL,(30,30),RLSE),UNIT=SYSDA,
//            DCB=(LRECL=100,BLKSIZE=0,RECFM=FB)
//SASLIST  DD SYSOUT=X
