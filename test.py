...
//DEL1     DD DSN=CIS.MYKADBDS.LOAD,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DEL2     DD DSN=CIS.MYKADBDS.REJECT,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//*---------------------------------------------------------------------
//*  PROCESS ACCOUNT INFORMATION
//*---------------------------------------------------------------------
//MYKADBDS EXEC SAS609
//MYKAD    DD DISP=SHR,DSN=CIS.MYKADBDS
//REJECT   DD DSN=CIS.MYKADBDS.REJECT,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(200,100),RLSE),
//            DCB=(LRECL=700,BLKSIZE=0,RECFM=FB)
//LOADFILE DD DSN=CIS.MYKADBDS.LOAD,
//            DISP=(NEW,CATLG,DELETE),
