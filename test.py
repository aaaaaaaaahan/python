...
# ------------------------
addr = pl.read_parquet("cis_internal/rawdata_converted/ADDRLINE_FB.parquet")
aele = pl.read_parquet("cis_internal/rawdata_converted/ADDRAELE_FB.parquet")
...
##ddraele1.write_parquet("cis_internal/output/CCRSADR4_VERIFY.parquet")
##addraele1.write_csv("cis_internal/output/CCRSADR4_VERIFY.csv")
...
##    ])
##)
##upd.write_parquet("cis_internal/output/CCRSADR4_UPDATE.parquet")
##upd.write_csv("cis_internal/output/CCRSADR4_UPDATE.csv")
