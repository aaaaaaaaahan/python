...
//DLT1     DD DSN=RHOLD.FULL.LIST,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT2     DD DSN=RHOLD.FULL.LIST.PIVB,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT3     DD DSN=RHOLD.FULL.LIST.LABUAN,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT4     DD DSN=RHOLD.FULL.LIST.PMB,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//DLT5     DD DSN=RHOLD.FULL.LIST.CTOS,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,(0))
//*---------------------------------------------------------------------
...
//OUTFILE   DD DSN=RHOLD.FULL.LIST,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(CYL,(300,300),RLSE),
//             DCB=(LRECL=1500,BLKSIZE=0,RECFM=FB)
//PIVBFILE  DD DSN=RHOLD.FULL.LIST.PIVB,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(CYL,(300,300),RLSE),
//             DCB=(LRECL=1500,BLKSIZE=0,RECFM=FB)
//LABUANFL  DD DSN=RHOLD.FULL.LIST.LABUAN,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(CYL,(300,300),RLSE),
//             DCB=(LRECL=1500,BLKSIZE=0,RECFM=FB)
//PMBFILE   DD DSN=RHOLD.FULL.LIST.PMB,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(CYL,(300,300),RLSE),
//             DCB=(LRECL=1500,BLKSIZE=0,RECFM=FB)
//CTOSFILE  DD DSN=RHOLD.FULL.LIST.CTOS,
//             DISP=(NEW,CATLG,DELETE),
//             UNIT=SYSDA,SPACE=(CYL,(300,300),RLSE),
//             DCB=(LRECL=1500,BLKSIZE=0,RECFM=FB)
//SASLIST   DD SYSOUT=X
